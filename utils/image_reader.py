...
def read_images_from_disk(input_queue, input_size_img,input_size_label, random_scale, image_mean):
    ...
    if input_size_img is not None:
        h, w = input_size_img
        h_label,w_label = input_size_label
        if random_scale:
        ...
        label = tf.image.resize_image_with_crop_or_pad(label, h_label, w_label)
    # RGB -> BGR.
...
class ImageReader(object):
    ...
    def __init__(self, data_dir, data_list, input_size_img, input_size_label, random_scale, image_mean,coord):
        ...
        self.input_size_label = input_size_label
        self.coord = coord
        ...
        self.queue = tf.train.slice_input_producer([self.images, self.labels],
                                                   shuffle=input_size_img is not None) # Not shuffling if it is val.
        self.image, self.label = read_images_from_disk(self.queue, self.input_size_img, self.input_size_label, random_scale, image_mean)
