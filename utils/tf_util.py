...
def atrous_conv2d(inputs,
  ...
  with tf.variable_scope(scope) as sc:
      ...
      outputs = tf.nn.atrous_conv2d(inputs, kernel,rate,padding=padding)
...
def batch_norm_template(inputs, is_training, scope, moments_dims, bn_decay):
  ...
  with tf.variable_scope(scope) as sc:
    ...
    # variables_to_restore = ema.average_name(batch_mean)
    # print 'start',variables_to_restore,'end'
    # print tf.get_default_graph().get_tensor_by_name(variables_to_restore)
